      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 col-md-offset-4">
            ...
            <h4 class="white">KLISE(Komunitas peduLI SEsama)</h4>
          ...
          <h5 class="white">Copyright &copy; SAWAN 2017</h5>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h4></h4>
        <p>Program ini dibuat oleh SAWAN untuk Tugas Pemrograman Web.</p>
